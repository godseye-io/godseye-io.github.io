...
fs.readFile('images/world-map.svg', 'utf8', (err, xml) => {
    if (err) {throw err}
...
// console.log('difference 2 end')
            ...
            fs.writeFile('data/world-map-4326-19.json', JSON.stringify({type: 'FeatureCollection', features: features}, null, 4), (err, res) => {
                if (err) {throw err}
